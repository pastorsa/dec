...
#include <dec_utilities/accumulator.h>
#include <dec_utilities/AccumulatedTrialStatistics.h>
...
TEST(UscUtilitiesAccumulator, computeMean)
{
  ...
  dec_utilities::read(node_handle, "accumulator_data_1", data_trace_1);
  dec_utilities::read(node_handle, "accumulator_data_2", data_trace_2);
  dec_utilities::read(node_handle, "accumulator_data_3", data_trace_3);

  dec_utilities::read(node_handle, "accumulator_mean", accumulator_mean);
  dec_utilities::read(node_handle, "accumulator_variance", accumulator_variance);
  ...
  std::vector<dec_utilities::AccumulatedTrialStatistics> accumulated_trial_statistics;

...
#include <dec_audio/DumpRawAudio.h>
#include <dec_audio/SetBackgroundNoise.h>
#include <dec_audio/circular_message_buffer.h>
...
public:
   ...
   * @return True on success, otherwise False
   */
  bool registerCallback(boost::function<void (const dec_audio::AudioSample::ConstPtr& audio_sample_msg)> callback);
   ...
   * @return
   */
  bool dumpRawAudio(dec_audio::DumpRawAudio::Request& request,
   ...
   * @return
   */
  //  bool setBackgroundNoise(dec_audio::SetBackgroundNoise::Request& request,
...
private:
  ...
  unsigned int output_start_index_;
  unsigned int output_end_index_;
  unsigned int num_selected_output_signals_;

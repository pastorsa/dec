...
static void fillAddr(const string &address, unsigned int port, sockaddr_in &addr)
{
...
unsigned int Socket::getLocalPort() throw (SocketException)
{
  sockaddr_in addr;
  unsigned int addr_len = sizeof(addr);
...
void Socket::setLocalPort(unsigned int localPort) throw (SocketException)
{
...
void Socket::setLocalAddressAndPort(const string &localAddress, unsigned int localPort) throw (SocketException)
{
...
unsigned int Socket::resolveService(const string &service, const string &protocol)
{
...
void CommunicatingSocket::connect(const string &foreignAddress, unsigned int foreignPort) throw (SocketException)
{
  // Get the address of the requested host
...
unsigned int CommunicatingSocket::getForeignPort() throw (SocketException)
{
  sockaddr_in addr;
  unsigned int addr_len = sizeof(addr);
...
//}
//
//TCPSocket::TCPSocket(const string &foreignAddress, unsigned int foreignPort)
...
//
//TCPServerSocket::TCPServerSocket(unsigned int localPort, int queueLen)
...
//    unsigned int localPort, int queueLen)
//    throw(SocketException) : Socket(SOCK_STREAM, IPPROTO_TCP) {
...
UDPSocket::UDPSocket(unsigned int localPort) throw (SocketException) :
    CommunicatingSocket(SOCK_DGRAM, IPPROTO_UDP)
{
  setLocalPort(localPort);
  setBroadcast();
...
UDPSocket::UDPSocket(const string &localAddress, unsigned int localPort) throw (SocketException) :
    CommunicatingSocket(SOCK_DGRAM, IPPROTO_UDP)
{
  setLocalAddressAndPort(localAddress, localPort);
  setBroadcast();
...
unsigned int UDPSocket::sendTo(const void *buffer, int bufferLen, const string &foreignAddress, unsigned int foreignPort)
...
int UDPSocket::recvFrom(void *buffer, int bufferLen, string &sourceAddress, unsigned int &sourcePort)
    throw (SocketException)
{

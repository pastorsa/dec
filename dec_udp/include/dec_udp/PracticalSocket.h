...
public:
   ...
   *   @exception SocketException thrown if fetch fails
   */
  unsigned int getLocalPort() throw(SocketException);
   ...
   */
  void setLocalPort(unsigned int localPort) throw(SocketException);
  ...
  void setLocalAddressAndPort(const std::string &localAddress,
    unsigned int localPort = 0) throw(SocketException);
   ...
   */
  static unsigned int resolveService(const std::string &service,
...
public:
   ...
   */
  void connect(const std::string &foreignAddress, unsigned int foreignPort)
   ...
   */
  unsigned int getForeignPort() throw(SocketException);
...
//   *   @exception SocketException thrown if unable to create TCP socket
//   */
//  TCPSocket(const std::string &foreignAddress, unsigned int foreignPort)
//      throw(SocketException);
//
//private:
...
//   */
//  TCPServerSocket(unsigned int localPort, int queueLen = 5)
//      throw(SocketException);
//
//  /**
//   *   Construct a TCP socket for use with a server, accepting connections
...
//   *   @exception SocketException thrown if unable to create TCP server socket
//   */
//  TCPServerSocket(const std::string &localAddress, unsigned int localPort,
...
public:
   ...
   *   @exception SocketException thrown if unable to create UDP socket
   */
  UDPSocket(unsigned int localPort) throw(SocketException);
   ...
   *   @exception SocketException thrown if unable to create UDP socket
   */
  UDPSocket(const std::string &localAddress, unsigned int localPort)
      throw(SocketException);
   ...
   */
  unsigned int sendTo(const void *buffer, int bufferLen, const std::string &foreignAddress,
            unsigned int foreignPort) throw(SocketException);

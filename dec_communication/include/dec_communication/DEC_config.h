...
#define DEC_MAX_NUMBER_OF_SENSORS_PER_NODE (uint8_t)10
#define DEC_MAX_NUMBER_OF_LED_STRIPS_PER_NODE (uint8_t)9
#define DEC_MAX_NUMBER_OF_BLOCKS_PER_LIGHT_STRIP (uint8_t)10
#define DEC_MAX_NUMBER_OF_PIXELS_PER_LIGHT_STRIP (uint8_t)255
